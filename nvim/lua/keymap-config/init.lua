...
-- -- search notes
-- key_map("n", "#n", [[<Cmd>lua require'telescope-config'.grep_notes()<CR>]], { noremap = true, silent = true })
-- -- Find files in config dirs
-- key_map("n", "#c", [[<Cmd>lua require'telescope-config'.find_configs()<CR>]], { noremap = true, silent = true })
-- -- registers picker
