# Generated by Powerlevel10k configuration wizard on 2026-01-30 at 14:54 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # pyenv                 # python environment - using asdf instead
    # goenv                 # go environment - using asdf instead
    # nodenv                # node.js version from nodenv - using asdf instead
    # nvm                   # node.js version from nvm - using asdf instead
    # nodeenv               # node.js environment - using asdf instead
    ...
    # rbenv                 # ruby version from rbenv - using asdf instead
    # rvm                   # ruby version from rvm - using asdf instead
    # fvm                   # flutter version management (https://github.com/leoafarias/fvm)
    # luaenv                # lua version from luaenv (https://github.com/cehoffman/luaenv)
    # jenv                  # java version from jenv - using asdf instead
  ...
  #############[ kubecontext: current kubernetes context (https://kubernetes.io/) ]#############
  # Always show kubecontext (commented out SHOW_ON_COMMAND)
  # Uncomment the next line to only show when typing k8s commands:
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      '*prod*'  PROD    # Production contexts (lowercase) - red background warning
      '*PROD*'  PROD    # Production contexts (uppercase) - red background warning
      '*Prod*'  PROD    # Production contexts (mixed case) - red background warning
      '*'       DEFAULT)
  # Production kubernetes context - red background as warning
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_FOREGROUND=7
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_BACKGROUND=1
  # Production content expansion (same as default - simplified)
  # Old: typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_CONTENT_EXPANSION='${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_NAME}}${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'
  ...
  #   - P9K_KUBECONTEXT_CLOUD_CLUSTER=my-cluster-01
  # Simplified kubecontext - just show context name (faster)
  # Old (extracts cloud cluster from ARN):
  # typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION=
  # POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_NAME}}'
  # POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION='${P9K_KUBECONTEXT_NAME}${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'

  # Custom prefix.
  # typeset -g POWERLEVEL9K_KUBECONTEXT_PREFIX='at '

  #[ aws: aws profile (https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-profiles.html) ]#
  # Always show aws profile (commented out SHOW_ON_COMMAND)
  # Uncomment the next line to only show when typing aws/terraform commands:
